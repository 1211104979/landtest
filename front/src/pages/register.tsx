...
const RegistrationPage: React.FC = () => {
  ...
  const connectMetaMask = async () => {
    ...
    try {
      ...
      if (accounts.length > 0) {
        ...
        const balanceInEther = (parseInt(balanceHex, 16) / Math.pow(10, 18)).toFixed(4);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const tx = await registerUserWithCID(
  contract,
  userAddress,
  {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Register for secure access to the blockchain-based land management platform. 
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-xl p-8">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {metaMaskAccount.address.slice(0, 6)}...{metaMaskAccount.address.slice(-4)}
                    </p>
                  </div>
                </div>
          ...
          <div className="mb-8 p-6 bg-blue-50 rounded-xl border border-blue-200">
            <div className="flex items-start">
              ...
              <div>
                <h4 className="font-semibold text-blue-900 mb-2">Security & Verification Notice</h4>
                <ul className="text-sm text-blue-800 space-y-1">
                  <li>• Your registration will undergo manual verification by our security team</li>
                  <li>• All government credentials will be cross-verified with official databases</li>
                  <li>• Your wallet address will be linked to your government identity</li>
                  <li>• Access will be granted only after successful verification (2-3 business days)</li>
